...
async function initDB() {
    ...
    try {
        ...
        const migrations = [
            ...
            // Testimonials — link to doctor, hospital, specialty, treatment
            "ALTER TABLE testimonials ADD COLUMN IF NOT EXISTS doctor_id INTEGER REFERENCES doctors(id)",
            "ALTER TABLE testimonials ADD COLUMN IF NOT EXISTS hospital_id INTEGER REFERENCES hospitals(id)",
            "ALTER TABLE testimonials ADD COLUMN IF NOT EXISTS specialty_id INTEGER REFERENCES specialties(id)",
            "ALTER TABLE testimonials ADD COLUMN IF NOT EXISTS treatment_id INTEGER REFERENCES treatments(id)",

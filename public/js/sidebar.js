...
window.gingerUser = (async function() {
    ...
    const menu = [
        ...
        { href: '/specialties', icon: '🏷️', label: 'Specialties', roles: ['super_admin', 'editor'] },
        { href: '/treatments', icon: '💊', label: 'Treatments', roles: ['super_admin', 'editor'] },
        { href: '/destinations', icon: '🌍', label: 'Destinations', roles: ['super_admin', 'editor'] },
        ...
        { href: '/accreditations-mgmt', icon: '🏅', label: 'Accreditations', roles: ['super_admin', 'editor'] },
